...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    [SerializeField] private Transform kitchenObjectHomePoint;
    ...
    private void HandleMovement() {
        ...
        if (!canMove) {
            ...
            if (canMove) {
                //can only move in the x axis
                moveDir = moveDirX;
            } else {
                //cannot move only on the x then attempt only z movement
